...
{
    public class InMemoryStorage : IWalletStorage
    {
        // Permanent storage
        public Dictionary<string, string> StoredMetadata { get; } = new Dictionary<string, string>();
        public List<StorageRecord> StoredRecords { get; } = new List<StorageRecord>();

        // In memory handles
        public Dictionary<int, string> MetadataHandles { get; } = new Dictionary<int, string>();
        public Dictionary<int, string> StorageHandles { get; } = new Dictionary<int, string>();
        public Dictionary<int, StorageRecord> RecordHandles { get; } = new Dictionary<int, StorageRecord>();
